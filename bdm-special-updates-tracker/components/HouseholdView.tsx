...
export const HouseholdView: React.FC<HouseholdViewProps> = ({ records, onImportClick, onSyncCloud, onClearDatabase, isSyncing }) => {
    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-[60vh] space-y-8 animate-in fade-in zoom-in duration-500">
            ...
            <div className="flex gap-4 pt-8">
                 ...
                 {onClearDatabase && (
                    <button onClick={onClearDatabase} className="bg-red-50 text-red-500 border border-red-100 px-6 py-3 rounded-2xl text-[11px] font-black uppercase tracking-widest shadow-sm hover:bg-red-500 hover:text-white transition-all">
