...
export const LoginView: React.FC<LoginViewProps> = ({ onLogin, onRegister, onGuestLogin, loginError }) => {
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    {!isRegistering && (
                        <button 
                            ...
                            className="w-full py-4 bg-white/5 border border-white/10 hover:bg-white/10 text-slate-300 hover:text-white rounded-2xl text-[10px] font-black uppercase tracking-widest transition-all active:scale-95 flex items-center justify-center space-x-2"
                        >
